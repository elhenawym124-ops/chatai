# 📚 توثيق نظام إدارة المحادثات

## نظرة عامة

هذا المجلد يحتوي على التوثيق الشامل لنظام إدارة المحادثات والذكاء الاصطناعي.

## 📋 فهرس التوثيق

### 📚 الوثائق الأساسية
- **[دليل التثبيت](./setup-guide.md)** - خطوات التثبيت والإعداد المفصلة
- **[وثائق API](./api-documentation.md)** - مرجع شامل لجميع endpoints
- **[تمييز أنواع الرسائل](./message-type-detection.md)** - شرح نظام التمييز البصري
