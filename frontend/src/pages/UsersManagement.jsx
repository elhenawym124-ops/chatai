...
const UsersManagement = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/companies/${user.companyId}/users?${queryParams}`, {
        headers: {
  ...
  const fetchRoles = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/v1/companies/${user.companyId}/roles`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('accessToken')}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchPlanLimits = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/api/v1/company/limits', {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('accessToken')}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchInvitations = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/companies/${user.companyId}/invitations`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('accessToken')}`,
          'Content-Type': 'application/json'
        }
  ...
  const handleSubmit = async () => {
    ...
    try {
      const url = editModalOpen 
        ? `http://localhost:3001/api/v1/companies/${user.companyId}/users/${selectedUser.id}`
        : `http://localhost:3001/api/v1/companies/${user.companyId}/users`;
  ...
  const handleDeleteUser = async (userToDelete) => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/v1/companies/${user.companyId}/users/${userToDelete.id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('accessToken')}`,
          'Content-Type': 'application/json'
