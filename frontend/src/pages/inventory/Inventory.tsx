...
const Inventory: React.FC = () => {
  ...
  const fetchInventory = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/inventory?${queryParams}`);
  ...
  const fetchAlerts = async () => {
    try {
      const response = await fetch('http://localhost:3001/api/v1/inventory/alerts');
      const data = await response.json();
  ...
  const updateStock = async () => {
    try {
      const response = await fetch('http://localhost:3001/api/v1/inventory/update-stock', {
        method: 'POST',
        headers: {
