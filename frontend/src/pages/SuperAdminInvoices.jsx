...
const SuperAdminInvoices = () => {
  ...
  const fetchInvoices = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/admin/invoices?${queryParams}`, {
        headers: {
  ...
  const fetchInvoiceStats = async () => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/v1/admin/invoices/stats/overview', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const handleSendInvoice = async (invoiceId) => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/admin/invoices/${invoiceId}/send`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleUpdateStatus = async (invoiceId, status) => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/admin/invoices/${invoiceId}/status`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
