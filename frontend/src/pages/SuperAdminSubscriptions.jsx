...
const SuperAdminSubscriptions = () => {
  ...
  const fetchSubscriptions = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/admin/subscriptions?${queryParams}`, {
        headers: {
  ...
  const handleCreateSubscription = async () => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/v1/admin/subscriptions', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleCancelSubscription = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/admin/subscriptions/${selectedSubscription.id}/cancel`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleRenewSubscription = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/admin/subscriptions/${selectedSubscription.id}/renew`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
