...
if [ -f /usr/share/nginx/html/index.html ]; then
    ...
    sed -i "s|%REACT_APP_API_URL%|${REACT_APP_API_URL:-http://localhost:3001/api/v1}|g" /usr/share/nginx/html/index.html
    sed -i "s|%REACT_APP_WS_URL%|${REACT_APP_WS_URL:-ws://localhost:3001}|g" /usr/share/nginx/html/index.html
