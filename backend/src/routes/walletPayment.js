...
router.post('/admin/wallet-numbers', async (req, res) => {
  try {
...
// تحديث رقم محفظة
router.put('/admin/wallet-numbers/:id', async (req, res) => {
  try {
    const { id } = req.params;
...
// حذف رقم محفظة
router.delete('/admin/wallet-numbers/:id', async (req, res) => {
  try {
    const { id } = req.params;
...
// مراجعة إيصال الدفع
router.post('/admin/review-receipt/:id', async (req, res) => {
  try {
    const { id } = req.params;
