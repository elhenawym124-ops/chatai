...
app.post('/api/v1/ai/direct-chat', async (req, res) => {
  try {
  ...
  try {
    ...
    for (const messaging of entry.messaging) {
      ...
      if (messaging.message) {
        console.log('✅ Message found, processing with smart delay...');
        ...
        console.log('❓ Unknown messaging event type:', Object.keys(messaging));
      }
    }
  } catch (error) {
